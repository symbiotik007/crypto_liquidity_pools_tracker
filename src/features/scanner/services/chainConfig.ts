...
export const CHAINS_CONFIG: Record<string, ChainConfig> = {
  ethereum: {
    label:      "Ethereum",
    chainId:    1,
    rpc:        _PROXY ? `${_PROXY}/eth-rpc` : 'https://eth.llamarpc.com',
  ...
  arbitrum: {
    label:      "Arbitrum",
    chainId:    42161,
    rpc:        _PROXY ? `${_PROXY}/arb-rpc` : 'https://arb1.arbitrum.io/rpc',
    nftManager: "0xC36442b4a4522E871399CD717aBDD847Ab11FE88",
    factory:    "0x1F98431c8aD98523631AE4a59f267346ea31F984",
  },
  optimism: {
    label:      "Optimism",
    chainId:    10,
    rpc:        _PROXY ? `${_PROXY}/op-rpc` : 'https://mainnet.optimism.io',
    nftManager: "0xC36442b4a4522E871399CD717aBDD847Ab11FE88",
    factory:    "0x1F98431c8aD98523631AE4a59f267346ea31F984",
  },
  base: {
    label:      "Base",
    chainId:    8453,
    rpc:        _PROXY ? `${_PROXY}/base-rpc` : 'https://mainnet.base.org',

// src/pages/Home.jsx
// Landing page principal de The Crypto House
// Diseño inspirado en Swiset — estructura como Capital Makers
// Paleta: #050a0f (dark), #00e5ff (cyan), #ffffff (white)
...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* TICKER */}
      <div className="ticker" style={{ marginTop: 72 }}>
      ...
      <section className="hero" id="inicio" style={{ marginTop: 0, paddingTop: 80 }}>
        ...
        <div className="hero-content">
          ...
          <div className="hero-stats">
            <div>
              <div className="hero-stat-val"><span>+</span>500</div>
